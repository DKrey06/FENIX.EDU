...
from schemas import (
    ...
    TokenResponse, UserUpdateStatus, UserListResponse,
    CourseCreate, GroupCreate
)
...
from dependencies import (
    get_current_user, require_admin, require_department_head,
    require_account_confirmation, redis_client
)
